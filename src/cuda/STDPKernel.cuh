...
#include <math.h>
#include "GPUCorticalStructures.h"
...
// Initialize cortical plasticity parameters
__device__ __constant__ CorticalPlasticityParams c_plasticity_params = {
    // Layer-specific A_plus (L1, L2, L3, L4, L5, L6)
    {0.005f, 0.015f, 0.015f, 0.010f, 0.012f, 0.008f},
    // Layer-specific A_minus
    {0.006f, 0.018f, 0.018f, 0.012f, 0.014f, 0.010f},
    // Layer-specific tau_plus (ms)
    {25.0f, 20.0f, 20.0f, 22.0f, 18.0f, 25.0f},
    // Layer-specific tau_minus (ms)
    {25.0f, 20.0f, 20.0f, 22.0f, 18.0f, 25.0f},
    
    // Cell-type gains
    1.0f,  // pyramidal_plasticity_gain
    0.7f,  // interneuron_plasticity_gain
    0.9f,  // stellate_plasticity_gain
